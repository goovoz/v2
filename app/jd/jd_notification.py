...
USER_AGENT = "jdapp;iPhone;10.5.0;13.3;network/wifi;Mozilla/5.0 (iPhone; " \
             "CPU iPhone OS 13_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko)" \
             " Mobile/15E148;supportJDSHWK/1"


class JdNotification(JdApp):
    """
    统一消息通知
    """
    def __init__(self, **kwargs):
        super(JdNotification, self).__init__(**kwargs)
        self.headers.update({
    ...
    async def request(self, url, **kwargs):
        ...
        try:
            ...
            self.print('请求服务器失败, {}, {}'.format(e.args, url))
            return dict()
